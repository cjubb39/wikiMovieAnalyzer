...
//System.out.println(selector);
			...
			case 1:
				...
				out.println(Jsoup
						.connect("http://en.wikipedia.org//wiki/Academy_Award_for_Writing_Original_Screenplay")
						.get().toString());
				out.close();
				break;

			case 2:
				ArrayList<HashedInfo> temp = new WikipediaParser()
						.getDecadeTableInfo("Best_Actor", 1);
			...
			case 5:
				...
				if (links.size() != 0) {
					 ...
					 * (infoCellMatcher.find()) { System.out.println(rowContents);
